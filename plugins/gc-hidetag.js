...
**/
    ...
    const htextos = `${text ? text : '*𝐏𝐚𝐧𝐝𝐚 𝐁𝐨𝐭 🐼🎋*'}`;
    if ((isMedia && quoted.mtype === 'imageMessage') && htextos) {
      ...
      await conn.relayMessage(m.chat, {extendedTextMessage: {text: `${masss}\n${htextos}\n`, ...{contextInfo: {mentionedJid: users, externalAdReply: {thumbnail: imagen1, sourceUrl: 'https://www.instagram.com/shadow.vz?igsh=bTRodW9oZXA1NXNz'}}}}}, {});
    }
  }
};
