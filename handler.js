    ...
    case 'remove':
      if (chat.welcome && !chat?.isBanned) {
        ...
        for (const user of participants) {
          let pp = 'https://raw.githubusercontent.com/LxShadow/PandaBot/master/src/pandava.png';
          try {
  ...
  for (const nk of callUpdate) {
    if (nk.isGroup == false) {
      if (nk.status == 'offer') {
        ...
        const vcard = `BEGIN:VCARD\nVERSION:3.0\nN:;𝐏𝐚𝐧𝐝𝐚 𝐁𝐨𝐭;;;\nFN:𝐏𝐚𝐧𝐝𝐚 𝐁𝐨𝐭\nORG:𝐏𝐚𝐧𝐝𝐚 𝐁𝐨𝐭\nTITLE:\nitem1.TEL;waid=5215541081250:+5215541081250\nitem1.X-ABLabel:𝐏𝐚𝐧𝐝𝐚 𝐁𝐨𝐭\nX-WA-BIZ-DESCRIPTION:[❗] ᴄᴏɴᴛᴀᴄᴛᴀ ᴀ ᴇsᴛᴇ ɴᴜᴍ ᴘᴀʀᴀ ᴄᴏsᴀs ɪᴍᴘᴏʀᴛᴀɴᴛᴇs.\nX-WA-BIZ-NAME:𝐏𝐚𝐧𝐝𝐚 𝐁𝐨𝐭\nEND:VCARD`;
        await mconn.conn.sendMessage(nk.from, { contacts: { displayName: '𝐏𝐚𝐧𝐝𝐚 𝐁𝐨𝐭', contacts: [{ vcard }] } }, { quoted: callmsg });
